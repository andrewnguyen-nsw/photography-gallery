...
const Feature = ({ icon, title, description }) => (
  <div className="rounded-lg border border-transparent hover:bg-white/50 hover:border-neutral-200/70 hover:drop-shadow-sm backdrop-filter backdrop-blur-lg bg-opacity-80 duration-100 ease-in-out p-6">
